...
class Message():
    ...
    def sendRREQ(uFlag, hopCount,id, originAddr, originSeq, destAddr, destSeq):
        ...
        print(str(Message.convert_to_bytes(1)) + str(Message.convert_to_bytes(uFlag)) + str(Message.convert_to_bytes(hopCount)) +
              str(Message.convert_to_bytes(id)) + str(Message.convert_to_bytes(originAddr)) + str(Message.convert_to_bytes(originSeq)) +
              str(Message.convert_to_bytes(destAddr)) + str(Message.convert_to_bytes(destSeq)))
